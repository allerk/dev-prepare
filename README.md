...
A collection of dotfiles, scripts and setup guides for a new machine.

## Contents

| Path | Description |
|------|-------------|
| `mac/TERMINAL-PREPARE.md` | macOS terminal setup guide (Zsh, Oh My Zsh, Powerlevel10k, Tmux) |
